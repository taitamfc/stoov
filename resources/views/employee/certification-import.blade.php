...
<section>
    <div class="card animated fadeInRight mr-5 ml-5">
        ...
        <div class="card-body">
            <form action="{{ route('certificationImportPost') }}" name="import_employee" id="import_employee" autocomplete="off" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                ...
                <div class="mt-1">
                    <div class="form-actions box-footer">
                        <button name="import_form" type="submit" class="btn btn-primary"><i class="fa fa fa-check-square-o"></i> {{ __('Save') }}
                        </button>
                    </div>
                </div>
            </form>
