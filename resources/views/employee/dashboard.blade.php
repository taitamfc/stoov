                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">{{ $employee->initialen }} {{ $employee->achternaam }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @php
                                                            $certification['examen_glasmonteur'] = trim($certification['examen_glasmonteur']);
                                                            $certification['examencode_glasmonteur'] = trim($certification['examencode_glasmonteur']);
                                                            $certification['examencijfer_glasmonteur'] = trim($certification['examencijfer_glasmonteur']);
                                                            if(!$certification['examen_glasmonteur'] && !$certification['examencode_glasmonteur'] && !$certification['examencijfer_glasmonteur']){
                                                                continue;
                                                            }
                                                        @endphp
                                                        <tr>
                                            ...
                                            <div class="col-md-12">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        @foreach ($certifications as $certification)
                                                        @php
                                                            $certification['hercertificeringscode_glasmonteur'] = trim($certification['hercertificeringscode_glasmonteur']);
                                                            $certification['hercertificeringscijfer_glasmonteur'] = trim($certification['hercertificeringscijfer_glasmonteur']);
                                                            $certification['hercertificeringspasnummer_glasmonteur'] = trim($certification['hercertificeringspasnummer_glasmonteur']);
                                                            if( !$certification['hercertificeringscode_glasmonteur'] && !$certification['hercertificeringscijfer_glasmonteur'] && !$certification['hercertificeringspasnummer_glasmonteur'] ){
                                                                continue;
                                                            }
                                                        @endphp
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">{{@$certifications[0]['pasje_gecertificeerd_glaszetter']}}</div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        @foreach ($certifications as $certification)
                                                            @php
                                                                $certification['examen_glaszetter'] = trim($certification['examen_glaszetter']);
                                                                $certification['examencode_glaszetter'] = trim($certification['examencode_glaszetter']);
                                                                $certification['examencijfer_glaszetter'] = trim($certification['examencijfer_glaszetter']);
                                                                if( !$certification['examen_glaszetter'] && !$certification['examencode_glaszetter'] && !$certification['examencijfer_glaszetter'] ){
                                                                    continue;
                                                                }
                                                            @endphp
                                                        <tr>
                                            ...
                                            <div class="col-md-12">
                                                <table>
                                                    ...
                                                    <tbody>
                                                        @foreach ($certifications as $certification)
                                                        @php
                                                            $certification['hercertificeringscode_glaszetter'] = trim($certification['hercertificeringscode_glaszetter']);
                                                            $certification['hercertificeringscijfer_glaszetter'] = trim($certification['hercertificeringscijfer_glaszetter']);
                                                            $certification['hercertificeringspasnummer_glaszetter'] = trim($certification['hercertificeringspasnummer_glaszetter']);
                                                            if( !$certification['hercertificeringscode_glaszetter'] && !$certification['hercertificeringscijfer_glaszetter'] && !$certification['hercertificeringspasnummer_glaszetter'] ){
                                                                continue;
                                                            }
                                                        @endphp
                                                        <tr>
