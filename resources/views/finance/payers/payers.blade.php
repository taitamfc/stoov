                ...
                <div class="card-body">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <form method="post" id="payers_form" class="form-horizontal" >
                            ...
                            <div class="col-md-4 form-group">
                                <input type="submit" name="payers_form_submit" id="payers_form_submit" class="btn btn-success" value={{trans("Save")}}>
                            </div>
                        </form>
                        <div class="container-fluid">
                            <div class="card">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" id="payers_form_edit" class="form-horizontal" enctype="multipart/form-data" >
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="submit" name="payers_edit_submit" id="payers_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                                            </div>
                                        </form>
                                    </div>
                                </div>
