        ...
        <div class="card-body">           
            ...
            <form method="post" id="warning_type_form" class="form-horizontal" >
                ...
                <div class="input-group">
                    ...
                    <input type="submit" name="warning_type_submit" id="warning_type_submit" class="btn btn-success" value={{trans("Save")}}>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="warning_type_form_edit" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="warning_type_edit_submit" id="warning_type_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
