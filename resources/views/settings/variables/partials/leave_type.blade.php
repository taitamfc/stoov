        ...
        <div class="card-body">
            ...
            <form method="post" id="leave_type_form" class="form-horizontal">
                ...
                <div class="input-group">
                    ...
                    <input type="submit" name="leave_type_submit" id="leave_type_submit" class="btn btn-success" value={{trans("Save")}}>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="leave_type_form_edit" class="form-horizontal" enctype="multipart/form-data" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="leave_type_edit_submit" id="leave_type_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
