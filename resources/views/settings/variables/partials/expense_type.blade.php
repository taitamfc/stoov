            ...
            <form method="post" id="expense_type_form" class="form-horizontal" >
                ...
                <div class="input-group">
                    <select name="company_id" id="company_id" class="form-control selectpicker"
                        ...
                        @php
                        $companies = App\Company::select('id', 'organisatie')->get();
                        @endphp
                    ...
                    <input type="submit" name="expense_type_submit" id="expense_type_submit" class="btn btn-success" value={{trans("Save")}}>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="expense_type_form_edit" class="form-horizontal"  >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="expense_type_edit_submit" id="expense_type_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
