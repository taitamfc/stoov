            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('employee_qualification.index')}}" id="employee_qualification-tab" data-toggle="tab" data-table= "employee_qualification" data-target="#employee_qualification" role="tab" aria-controls="employee_qualification" aria-selected="false">{{trans('Qualification')}}</a>
                        </li>
