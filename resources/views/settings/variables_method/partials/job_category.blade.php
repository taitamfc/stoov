        ...
        <div class="card-body">           
            ...
            <form method="post" id="job_category_form" class="form-horizontal" >
                ...
                <div class="input-group">
                    ...
                    <input type="submit" name="job_category_submit" id="job_category_submit" class="btn btn-success" value={{trans("Save")}}>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="job_category_form_edit" class="form-horizontal" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="job_category_edit_submit" id="job_category_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
