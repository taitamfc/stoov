        ...
        <div class="card-body">           
            ...
            <form method="post" id="travel_method_form" class="form-horizontal" >
                ...
                <div class="input-group">
                    ...
                    <input type="submit" name="travel_method_submit" id="travel_method_submit" class="btn btn-success" value={{trans("Save")}}>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form method="post" id="travel_method_form_edit" class="form-horizontal"  >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="travel_method_edit_submit" id="travel_method_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
