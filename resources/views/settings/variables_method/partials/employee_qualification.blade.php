                        ...
                        <div class="tab-pane fade show active pt-0" id="educationLevel" role="tabpanel" aria-labelledby="educationLevel-tab">
                            ...
                            <form method="post" id="education_level_form" class="form-horizontal mb-3" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="submit" name="education_level_submit" id="education_level_submit" class="btn btn-success" value={{trans("Save")}}>
                                </div>
                            </form>
                            <div class="row">
                        ...
                        <div class="tab-pane fade pt-0" id="languageSkills" role="tabpanel" aria-labelledby="languageSkills-tab">
                            ...
                            <form method="post" id="language_skill_form" class="form-horizontal mb-3" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="submit" name="language_skill_submit" id="language_skill_submit" class="btn btn-success" value={{trans("Save")}}>
                                </div>
                            </form>
                            <div class="row">
                                <div class="table-responsive">
                        ...
                        <div class="tab-pane fade pt-0" id="otherSkills" role="tabpanel" aria-labelledby="otherSkills-tab">
                            ...
                            <form method="post" id="general_skill_form" class="form-horizontal mb-3" >
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="submit" name="general_skill_submit" id="general_skill_submit" class="btn btn-success" value={{trans("Save")}}>
                                </div>
                            </form>
                            <div class="row">
                                <div class="table-responsive">
            ...
            <div class="modal-body">
                <form method="post" id="education_level_form_edit" class="form-horizontal"  >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="education_level_edit_submit" id="education_level_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                <form method="post" id="language_skill_form_edit" class="form-horizontal" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="language_skill_edit_submit" id="language_skill_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-body">
                <form method="post" id="general_skill_form_edit" class="form-horizontal"  >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="general_skill_edit_submit" id="general_skill_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
