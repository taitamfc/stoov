                 ...
                 <form method="post" id="sample_form" class="form-horizontal">
                     ...
                     <div class="row">
                         <div class="col-md-6 form-group">
                             ...
                             <input type="text" name="first_name" id="first_name" placeholder={{__('First Name')}} required class="form-control">
                         </div>
                         <div class="col-md-6 form-group">
                             <label>{{__('Last Name')}} <span class="text-danger">*</span></label>
                             <input type="text" name="last_name" id="last_name" placeholder={{__('Last Name')}} required class="form-control">
                         </div>
                         <div class="col-md-6">
                             <div class="form-group">
                                 <label class="text-bold">{{__('Berdrijf')}} <span class="text-danger">*</span></label>
                                 <select name="company_id" id="company_id" required class="form-control selectpicker dynamic" data-live-search="true" data-live-search-style="contains" data-shift_name="shift_name" data-dependent="department_name" title="{{__('Selecting',['key'=>__('Berdrijf')])}}...">
                         ...
                         <div class="col-md-6 form-group">
                             ...
                             <input type="text" name="username" id="username" placeholder="{{__('Username')}}" required class="form-control">
                         </div>
                         ...
                         <div class="col-md-6 form-group">
                             ...
                             <input type="text" name="contact_no" id="contact_no" placeholder="{{__('Phone')}}" class="form-control" value="{{ old('contact_no') }}">
                         </div>
                         ...
                         <div class="col-md-6 form-group">
                             ...
                             <input type="text" name="address1" id="address1" placeholder="{{__('Address Line 1')}}" class="form-control">
                         </div>

                         <div class="col-md-6 form-group">
                             <label>{{__('Address Line 2')}} </label>
                             <input type="text" name="address2" id="address2" placeholder="{{__('Address Line 2')}}" class="form-control">
                         </div>

                         <div class="col-md-6 form-group">
                             <label>{{__('City')}} </label>
                             <input type="text" name="city" id="city" placeholder="{{__('City')}}" class="form-control">
                         </div>

                         <div class="col-md-6 form-group">
                             <label>{{__('State/Province')}} </label>
                             <input type="text" name="state" id="state" placeholder="{{__('State/Province')}}" class="form-control">
                         </div>

                         <div class="col-md-6 form-group">
                             <label>{{__('ZIP')}} </label>
                             <input type="text" name="zip" id="zip" placeholder="{{__('ZIP')}}" class="form-control">
                         </div>


                         <div class="col-md-6 form-group">
                             <label>{{__('Country')}}</label>
                             <select name="country" id="country" class="form-control selectpicker" data-live-search="true" data-live-search-style="contains" title='{{__('Selecting',['key'=>__('Country')])}}...'>
                         ...
                         <div class="col-md-6 form-group">
                             ...
                             <input type="file" id="profile_photo" class="form-control @error('photo') is-invalid @enderror" name="profile_photo" placeholder={{__('Upload')}} {{__('Photo')}}>
                         </div>
                         ...
                         <div class="container">
                             <div class="form-group" align="center">
                                 <input type="hidden" name="action" id="action" value='{{__("Add")}}' />
                                 <input type="hidden" name="hidden_id" id="hidden_id" />
                                 <input type="submit" name="action_button" id="action_button" class="btn btn-warning" value="{{__('Add')}}">
                             </div>
                         </div>
                     </div>
 ...
 <script type="text/javascript">
     (function($) {
         ...
         $(document).on('click', '#bulk_delete', function() {
             ...
             if (id.length > 0) {
                 if (confirm("{{__('Delete Selection',['key'=>__('Client')])}}")) {
                     $.ajax({
