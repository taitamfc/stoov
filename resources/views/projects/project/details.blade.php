                                                ...
                                                <td>
                                                    <form method="post" id="assigned_form" class="form-horizontal">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            @can('assign-project')
                                                                <div class="col-md-6 form-group">
                                                                    <input type="submit" name="assigned_submit" id="assigned_submit" class="btn btn-success btn-sm" value={{trans("Save")}}>
                                                                </div>
                                                            @endcan
                                                        </div>
                                                    </form>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="collapse" id="collapseDiscussion">
                                                ...
                                                <form method="post" id="discussions_form" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="submit" name="discussions_submit" id="discussions_submit" class="btn btn-success" value={{trans("Save")}}>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <form method="post" id="progress_form" class="form-horizontal">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <input type="submit" name="project_progress_submit"
                                                   ...
                                                   class="btn btn-success" value={{trans("Save")}}>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <div class="collapse" id="collapseBug">
                                                ...
                                                <form method="post" id="bugs_form" class="form-horizontal"
                                                    ...
                                                    <div class="form-group">
                                                        <input type="submit" name="bugs_submit" id="bugs_submit" class="btn btn-success" value={{trans("Save")}}>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <form method="post" id="note_form" class="form-horizontal">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <input type="submit" name="project_note_submit" id="project_note_submit" class="btn btn-success" value={{trans("Save")}}>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
