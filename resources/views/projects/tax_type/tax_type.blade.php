...
<form method="post" id="tax_type_form" class="form-horizontal" >
    ...
    <div class="col-md-4 form-group">
        <input type="submit" name="tax_type_submit" id="tax_type_submit" class="btn btn-success" value={{trans("Save")}}>
    </div>
</form>
<div class="container-fluid">
    <div class="card">
            ...
            <div class="modal-body">
                <form method="post" id="tax_type_form_edit" class="form-horizontal" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="submit" name="tax_type_edit_submit" id="tax_type_edit_submit" class="btn btn-success" value={{trans("Edit")}} />
                    </div>
                </form>
            </div>
        </div>
