                ...
                <div class="gform_body gform-body">
                    <div id="gform_fields_10" class="gform_fields  ">
                        <div class="gform_section">
                            <div id="field_10_9" class="gfield gf-col-2">
                                <h2 class="gsection_title">Werkgevergegevens</h2>
                            </div>
                            <div class="gfield  gfield_contains_required gf-col-2">
                            ...
                            <div id="field_iban_nummer" class="gfield   gfield_contains_required  gf-col-2">
                        ...
                        <div class="gform_section">
                            <div id="field_10_22" class="gfield gf-col-2 ">
                                <h2 class="gsection_title">Gegevens cursus</h2>
                            </div>
                            <div id="field_course" class="gfield gfield_contains_required   gf-col-2 ">
                            ...
                            <div id="field_naam_cursus" class="gfield gfield_contains_required    gf-col-2 ">
                                ...
                                <div class="ginput_container ginput_container_select ">
                                    <select name="naam_cursus" id="input_naam_cursus" class="medium gfield_select">
                                        ...
                                        <option value="{{ $course->id }}" data-status="{{ $course->status }}" data-price="{{ $course->price }}" data-percentage="{{ $course->percentage }}" {{ ($fields['naam_cursus'] ?? null) == $course->id ? "selected" : null }}>{{ $course->value }}</option>
                                        @endforeach
                                    </select>
                                </div>

                            </div>
                            <div id="field_cursus_info" class="course hide gfield gfield_contains_required  gf-col-2  " style="display: none;">
                            ...
                            <div id="field_naam_opleidingsinstituut" class="gfield gfield_contains_required  gf-col-2  ">
                            ...
                            <div id="field_informatie_over_het_opleidingsinstituut" class=" gf-col-2 course hide gfield gfield_contains_required" style="display: none;">
                            ...
                            <div id="field_datum_cursus_van" class=" gf-col-2 gfield  gfield_contains_required  gf-col-2">
                            ...
                            <div id="field_datum_tot" class="gfield  gf-col-2 gfield_contains_required  gf-col-2">
                            ...
                            <div id="field_subsidiepercentage_dat_van_toepassing_is" class=" gf-col-2 gfield gfield_contains_required ">
                            ...
                            <div id="field_totaalbedrag_subsidie_aanvraag" class=" gf-col-2 gfield gfield_contains_required   ">
                            ...
                            <div id="field_factuur" class="gfield gf_left gfield_contains_required   gf-col-2">
                            ...
                            <div id="field_certificaat" class="gfield gf_right gfield_contains_required  gf-col-2  ">
                        ...
                        <div class="gform_section">
                            ...
                            <div id="field_deelnemers" class="gfield gfield--width-full gfield_contains_required   gf-col-2">
                        ...
                        <div class="gform_section">
                            <div id="field_aantal_deelnemers_in_cursus" class="deelnemers hide gfield gfield_contains_required hide select_great_more  gf-col-2" style="display: none;">
                            ...
                            <div id="field_10_25" class="gfield gf-col-2">
