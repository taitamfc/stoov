                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="company_id">{{__('Berdrijf')}}</label>
                                    <select name="company_id" id="company_id" required
                                            class="form-control selectpicker"
                                            data-live-search="true" data-live-search-style="contains"
                                            title='{{__('Selecting',['key'=>__('Berdrijf')])}}...'>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="min_experience" id="min_experience" required
                                        ...
                                        data-live-search="true" data-live-search-style="contains"
                                        title="Select Option...">
                                    <option value="Fresh">{{trans('Fresh')}}</option>
                                    <option value="1 Years">1 {{trans('Years')}}</option>
                                    <option value="2 Years">2 {{trans('Years')}}</option>
                                    <option value="3 Years">3 {{trans('Years')}}</option>
                                    <option value="4 Years">4 {{trans('Years')}}</option>
                                    <option value="5 Years">5 {{trans('Years')}}</option>
                                    <option value="6 Years">6 {{trans('Years')}}</option>
                                    <option value="7 Years">7 {{trans('Years')}}</option>
                                    <option value="8 Years">8 {{trans('Years')}}</option>
                                    <option value="9 Years">9 {{trans('Years')}}</option>
                                    <option value="10 Years">10 {{trans('Years')}}</option>
                                    <option value="+10 Years">+10 {{trans('Years')}}</option>
                                </select>
                            </div>
