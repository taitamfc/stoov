                    ...
                    @can('store-user')
                        <div class="dropdown mr-1">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="#" name="create_record" id="create_record">Beheerder toevoegen</a>
                                @endif
                                <a class="dropdown-item" href="{{url('/staff/employees')}}#formModal">Werknemer toevoegen</a>
                                <a class="dropdown-item" href="{{url('/project-management/clients')}}#formModal">Klant toevoegen</a>
                            </div>
                        </div>
                    @endcan
                    @can('delete-user')
