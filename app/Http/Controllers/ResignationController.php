...
class ResignationController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'employee_name' => $employee_name, 'organisatie' => $organisatie, 'department' => $department]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-resignation'))
		{
			...
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Resignation')])]);
			} else
			{
