...
//				]
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'organisatie' => $organisatie, 'employee_name' => $collection,
...
//				]
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-meeting'))
		{
			...
			if ($meeting->delete())
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Meeting')])]);
			} else
			{
	...
	public function calendarableDetails($id)
	{
		if (request()->ajax())
		{
			$data = Meeting::with('company:id,organisatie',
