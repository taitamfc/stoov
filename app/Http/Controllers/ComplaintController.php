...
class ComplaintController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'complaint_from' => $complaint_from, 'organisatie' => $organisatie, 'complaint_against' => $complaint_against]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-complaint'))
		{
			...
			if ($complaint->delete())
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Complaint')])]);
			} else
			{
