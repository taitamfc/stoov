...
class AssetController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'employee_name' => $employee_name, 'organisatie' => $organisatie, 'assets_category_name' => $assets_category_name]);
		}
	}
...
//				]
	...
	public function delete_by_selection(Request $request)
	{
		...
		return response()->json(['success' => __('Multi Delete', ['key' => trans('Travel')])]);
	}
