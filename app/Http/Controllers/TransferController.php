...
class TransferController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'employee_name' => $employee_name, 'organisatie' => $organisatie, 'from_department' => $from_department, 'to_department' => $to_department]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-transfer'))
		{
			...
			if ($transfer->delete())
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Transfer')])]);
			} else
			{
