...
class TrainingListController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'trainer_name' => $trainer_name, 'organisatie' => $organisatie, 'TrainingType_name' => $TrainingType_name,
	...
	public function calendarableDetails($id)
	{
		if (request()->ajax())
		{
			$data = TrainingList::with('company:id,organisatie',
