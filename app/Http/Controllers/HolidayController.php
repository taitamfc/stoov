...
class HolidayController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'organisatie' => $organisatie]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-holiday'))
		{
			...
			if ($holiday->delete())
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Holiday')])]);
			} else
			{
	...
	public function calendarableDetails($id)
	{
		if (request()->ajax())
		{
			$data = Holiday::with('company:id,organisatie')->findOrFail($id);
