...
class ClientController extends Controller {
	...
	public function index()
	{
		...
		if ($logged_user->can('view-client'))
		{
			...
			return view('projects.client.index', compact('countries', 'companies'));
		}
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('username', 'company_id', 'first_name','last_name', 'password', 'contact_no', 'email', 'website', 'address1', 'address2',
	...
	public function update(Request $request)
	{
		...
		if ($logged_user->can('edit-client'))
		{
			...
			$validator = Validator::make($request->only('username', 'company_id', 'first_name', 'last_name', 'contact_no', 'email', 'website', 'address1', 'address2',
				'city', 'state', 'country', 'zip', 'profile_photo'),
				[
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-client'))
		{
			...
			return response()->json(['success' => __('Multi Delete', ['key' => trans('Client')])]);
		}
