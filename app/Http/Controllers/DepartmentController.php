...
class DepartmentController extends Controller {
	...
	public function index()
	{
		...
		if (request()->ajax())
		{
			return datatables()->of(department::with('company:id,organisatie', 'DepartmentHead:id,first_name,last_name')->get())
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-department'))
		{
			...
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Department')])]);
			} else
			{
