...
class AppraisalController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax())
        {
            $appraisals = Appraisal::with('company:id,organisatie','employee:id,first_name,last_name','department:id,department_name','designation:id,designation_name')
                        ->orderBy('id','DESC')->get();
            ...
            return DataTables::of($appraisals)
                ...
                ->addIndexColumn()
                ->addColumn('organisatie', function ($row)
                {
