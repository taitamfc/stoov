...
class JobEmployerController extends Controller {
	...
	public function store(Request $request)
	{
		...
		{
			$validator = Validator::make($request->only('username', 'organisatie', 'first_name', 'last_name', 'password', 'contact_no', 'email',
				'logo'),
				[
	...
	public function update(Request $request)
	{
		...
		if ($logged_user->can('edit-job_employer'))
		{
			...
			$validator = Validator::make($request->only('username', 'organisatie', 'first_name', 'last_name', 'contact_no', 'email',
				'logo'),
				[
