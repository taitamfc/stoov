...
class WarningController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'warning_to_employee' => $warning_to, 'organisatie' => $organisatie, 'warning_type_name' => $warning_type_name]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-warning'))
		{
			...
			if ($warning->delete())
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Warning')])]);
			} else
			{
