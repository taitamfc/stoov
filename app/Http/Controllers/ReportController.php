	...
	public function training(Request $request)
	{
		...
		if ($logged_user->can('report-training'))
		{
			if (request()->ajax())
			{
				...
				{
					$trainings = TrainingList::with('company:id,organisatie', 'trainer:id,first_name,last_name',
				...
				return datatables()->of($trainings)
					...
					{
						return $row->start_date . ' ' . trans('To') . ' ' . $row->end_date;
					})
					->make(true);
			}
	...
	public function employees(Request $request)
	{
		...
		if ($logged_user->can('report-employee'))
		{
			if (request()->ajax())
			{
				...
				{
					$employees = Employee::with('company:id,organisatie', 'user:id,username',
			...
			if (request()->ajax())
			{
				...
				return datatables()->of($transactions)
					...
					->addColumn('type', function ($row)
					{
						...
						{
							return $row->expense_reference ? trans('Expense') : trans('Income');
						}
					})
