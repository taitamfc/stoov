...
class AnnouncementController extends Controller {
		...
		if (request()->ajax())
		{
			...
			return datatables()->of($announcements)
				...
				->addColumn('department', function ($row)
				{
					...
					return empty($row->department->department_name) ? __(trans('All_Department')) : $row->department->department_name;
				})
	...
	function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'department_name' => $department_name, 'organisatie' => $organisatie]);
		}
	}
	...
	function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-announcement'))
		{
			...
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Announcement')])]);
			} else
			{
