...
class TravelController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			$organisatie = $data->company->organisatie ?? '';
			$first_name = $data->employee->first_name ?? '';
			$last_name = $data->employee->last_name ?? '';
			$employee_name = $first_name . ' ' . $last_name;
			$arrangement_name = $data->TravelType->arrangement_type ?? '';

			return response()->json(['data' => $data, 'employee_name' => $employee_name, 'organisatie' => $organisatie, 'arrangement_name' => $arrangement_name]);
		}
	}
	...
	public function edit($id)
	{
		if (request()->ajax())
		{
			$data = Travel::with('company:id,organisatie', 'employee:id,first_name,last_name')
				->findOrFail($id);
