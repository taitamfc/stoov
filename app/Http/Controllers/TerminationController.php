...
class TerminationController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'termination_to_employee' => $termination_to, 'organisatie' => $organisatie, 'termination_type_name' => $termination_type_name]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-termination'))
		{
			...
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Termination')])]);
			} else
			{
