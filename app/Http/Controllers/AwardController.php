...
class AwardController extends Controller {
	...
	public function show($id)
	{
		if (request()->ajax())
		{
			...
			return response()->json(['data' => $data, 'employee_name' => $employee_name, 'organisatie' => $organisatie, 'department' => $department, 'award_name' => $award_name]);
		}
	}
	...
	public function delete_by_selection(Request $request)
	{
		...
		if ($logged_user->can('delete-award'))
		{
			...
			if ($award->delete())
			{
				return response()->json(['success' => __('Multi Delete', ['key' => trans('Award')])]);
			} else
			{
