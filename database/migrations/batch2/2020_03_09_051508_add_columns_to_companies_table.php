...
class AddColumnsToCompaniesTable extends Migration
{
	...
	public function up()
	{
		Schema::table('companies', function (Blueprint $table) {
			...
			$table->string('organisatie')->after('id');
	...
	{
		Schema::table('companies', function (Blueprint $table) {
			$table->dropColumn(['organisatie', 'company_type','trading_name', 'registration_no','contact_no','email','website','tax_no','address1','address2','city','state','country','zip','company_logo','is_active'
			]);
