...
Route::group(['middleware' => ['XSS']], function ()
{
    ...
    #Email contact
    require __DIR__ . '/v1/email-contact.php';
	...
	{
		{
			...
			Route::get('certificering/import', 'EmployeeController@certificationImport')->name('certificationImport');
			Route::post('certificering/import', 'EmployeeController@certificationImportPost')->name('certificationImportPost');
			//Irfan
	...
	Route::prefix('organization')->group(function ()
	{
		...
		}
		{
			...
			Route::get('companies/page/import', 'CompanyController@import')->name('companies.import');
			Route::post('companies/page/import', 'CompanyController@importPost')->name('companies.importPost');
...
//Route::resource('employees', 'EmployeeController');
	...
	{
		Route::get('verzoek_loonsomopgave', 'AdminCourseController@courseRequest')->name('course.course-request');
		Route::get('ingezonden_formulieren', 'AdminCourseController@index')->name('course.index');
		Route::get('ingezonden_formulieren/{id}', 'AdminCourseController@show')->name('course.show');
		Route::get('ingezonden_formulieren/{id}/edit', 'AdminCourseController@edit')->name('course.edit');
		Route::put('ingezonden_formulieren/{id}', 'AdminCourseController@update')->name('course.update');
		Route::post('ingezonden_formulieren', 'AdminCourseController@sendMails')->name('course.sendMails');
		Route::get('loonsomopgaves', 'AdminCourseController@loonsomopgaves')->name('loonsomopgaves');
		Route::get('loonsomopgaves/{id}', 'AdminCourseController@loonsomopgavesShow')->name('loonsomopgaves.show');
		Route::get('loonsomopgaves/{id}/edit', 'AdminCourseController@loonsomopgavesEdit')->name('loonsomopgaves.edit');
		

		Route::get('importeren/verletvergoeding-importeren', 'AdminCourseController@verletvergoedingImporteren')->name('course.verletvergoeding-importeren');
		Route::get('importeren/opleidingsvergoeding-importeren', 'AdminCourseController@opleidingsvergoedingImporteren')->name('course.opleidingsvergoeding-importeren');
		Route::get('importeren/loonsomopgave-importeren', 'AdminCourseController@loonsomopgaveImporteren')->name('course.loonsomopgave-importeren');
		
		Route::post('verletvergoeding-importeren', 'AdminCourseController@postVerletvergoedingImporteren')->name('course.post-verletvergoeding-importeren');
		Route::post('opleidingsvergoeding-importeren', 'AdminCourseController@postOpleidingsvergoedingImporteren')->name('course.post-opleidingsvergoeding-importeren');
		Route::post('loonsomopgave-importeren', 'AdminCourseController@postLoonsomopgaveImporteren')->name('course.post-loonsomopgave-importeren');

		Route::get('importeren/klanten-importeren', 'EmployeeController@klantenImporteren')->name('klanten.importeren');
		Route::post('klanten-importeren', 'EmployeeController@postKlantenImporteren')->name('klanten.post-importeren');
		
		Route::resource('email-settings', 'AdminEmailSettingController', ['names' => 'email_settings'])->except([
			'destroy', 'create'
		]);
		Route::resource('cursus-workshop', 'AdminPackageController', ['names' => 'naam_cursus']);
		Route::get('cursus-workshop/{id}/delete', 'AdminPackageController@destroy')->name('naam_cursus.destroy');
		Route::get('email-settings/{id}/delete', 'AdminEmailSettingController@destroy')->name('employees.destroy');
		Route::resource('verzoek_voor_wijzigingen', 'EmployeeRequestController', ['names' => 'employee-request']);
		Route::resource('budgets', 'AdminBudgetController', ['names' => 'budgets']);
		Route::get('beschikbare-budgetten', 'AdminBudgetController@beschikbareBudgetten')->name('beschikbare-budgetten');
		Route::get('beschikbare-budgetten-edit/{id}', 'AdminBudgetController@beschikbareBudgettenEdit')->name('beschikbare-budgetten-edit');
		Route::put('beschikbare-budgetten-edit/{id}', 'AdminBudgetController@beschikbareBudgettenUpdate')->name('beschikbare-budgetten-update');
		
		Route::get('budgets/{id}/delete', 'AdminBudgetController@destroy')->name('budgets.destroy');
		Route::get('importeren/budgetten-importeren', 'AdminBudgetController@budgettenImporteren')->name('budgets.importeren');
		Route::post('budgetten-importeren', 'AdminBudgetController@postBudgettenImporteren')->name('budgets.post-importeren');
			#GET
			Route::get('client/verletvergoeding', 'FrontEnd\CourseController@getContactInjuryCompensation')->name('client-get-verletvergoeding');
			Route::get('client/opleidingsvergoeding', 'FrontEnd\CourseController@getContactTrainingGrant')->name('get-contact-training-grant');
			Route::get('client/loonsomopgave', 'FrontEnd\CourseController@getLoonsomopgave')->name('client-get-loonsomopgave');
			#POST
			Route::post('client/verletvergoeding', 'FrontEnd\CourseController@postFormVerletvergoeding')->name('create-contact-injury-compensation');
			Route::post('client/opleidingsvergoeding', 'FrontEnd\CourseController@postFormOpleidingsvergoeding')->name('create-contact-training-grant');
			Route::post('client/loonsomopgave', 'FrontEnd\CourseController@postFormLoonsomopgave')->name('create-contact-wage-bill');
			Route::get('client/gegevens-wijzigens/index', 'ClientGegevensWijzigenController@index')->name('client.gegevens-wijzigens.index');
			Route::post('client/gegevens-wijzigens', 'ClientGegevensWijzigenController@store')->name('client.gegevens-wijzigens.store');
	});
});
//
